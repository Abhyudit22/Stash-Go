...
def create_sale(
    ...
    result = sale_crud.create_sale(db, sale, current_user.id)
...
def get_all_sales(
    ...
    sales = sale_crud.get_all_sales(db, current_user.id)
...
def get_sale_by_id(
    ...
    sale = sale_crud.get_sale_by_id(db, sale_id, current_user.id)
...
def get_sales_by_product(
    ...
    sales = sale_crud.get_sales_by_product(db, product_id, current_user.id)
...
def get_sales_ledger(
    ...
    # FIXED: Secure Database-Level Filtering!
    # We join the Bill table and filter it before it ever reaches Python.
    ...
    for item in records:
        result.append({
            ...
            "created_at": item.bill.created_date.isoformat() if item.bill else None
        })
    return result